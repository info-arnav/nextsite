  ...
  return (
    <div style={{}}>
      <Head>
        ...
        />
        <title>Infinity | Error 404</title>
        <meta property="og:title" content="Infinity | Error 404" />
        <meta name="twitter:title" content="Infinity | Error 404" />
        <meta
          name="description"
          content="You may have landed on an non existing link. No worries use to options provided on the page to get back on track."
        />
        <meta
